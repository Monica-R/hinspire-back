...
import { validateEmail, validatePasswordStrength } from '../validators/auth.validators.js';
...
router.put("/profile", isAuthenticated, validateEmail, validatePasswordStrength, editProfile);
